        ...
        <div className="flex flex-col md:flex-row gap-10 mb-10">
            ...
            <div className="md:w-3/5">
                ...
                <div className="flex gap-6 mt-2 justify-center md:justify-start">
                    <button className=" bg-white border-2 border-[#59C6D2] hover:bg-[#59C6D2] px-2 py-1 md:px-5 md:py-2 rounded-md md:rounded-lg text-black hover:text-white md:text-lg font-medium md:font-semibold">
                        Read
                    </button>

                    <button className=" bg-[#50B1C9] hover:bg-white hover:border-2 hover:border-[#50B1C9] hover:text-black px-2 py-1 md:px-4 md:py-2 rounded-md md:rounded-lg text-white md:text-lg font-medium md:font-semibold">
                        Wishlist
                    </button>
                </div>
